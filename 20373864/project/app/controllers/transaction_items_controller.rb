class TransactionItemsController < ApplicationController
  ...
  def create
    if User.find(transaction_item_params[:user_id]) and Product.find(transaction_item_params[:product_id]) and
      TransactionOrder.find(transaction_item_params[:transaction_order_id])

...
class AdministratorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create administrator" do
    assert_difference("Administrator.count") do
      post administrators_url, params: { administrator: { level: @administrator.level, password: @administrator.password, username: @administrator.username } }
    end
  ...
  test "should update administrator" do
    patch administrator_url(@administrator), params: { administrator: { level: @administrator.level, password: @administrator.password, username: @administrator.username } }
